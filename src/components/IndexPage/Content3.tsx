...
const getDelay = (e: any, b: any) => (e % b) * 100 + Math.floor(e / b) * 100 + b * 100;

const Content3: React.FC<any> = ({ dataSource, isMobile, ...props }) => {
  let clearFloatNum = 0;
  const children = dataSource.block.children.map((item: any, i: any) => {
